...
THREE.MedianFilter = {
	...
	fragmentShader: [
		...
		"void main() {",
			...
			"	texture2D(tDiffuse, vUv + ( max(onePixel * vec2( 1.0,  0.0), vec2(1.0, 1.0)) )) * 1.0 + ",
			"	texture2D(tDiffuse, vUv + ( max(onePixel * vec2( 1.0,  1.0), vec2(1.0, 1.0)) )) * 1.0 + ",
			"	texture2D(tDiffuse, vUv + ( max(onePixel * vec2( 0.0,  1.0), vec2(1.0, 1.0)) )) * 1.0 + ",
			"	texture2D(tDiffuse, vUv + ( max(onePixel * vec2(-1.0,  1.0), vec2(1.0, 1.0)) )) * 1.0 + ",
			"	texture2D(tDiffuse, vUv + ( max(onePixel * vec2(-1.0,  0.0), vec2(1.0, 1.0)) )) * 1.0 + ",
			"	texture2D(tDiffuse, vUv + ( max(onePixel * vec2(-1.0, -1.0), vec2(1.0, 1.0)) )) * 1.0 + ",
			"	texture2D(tDiffuse, vUv + ( max(onePixel * vec2( 0.0, -1.0), vec2(1.0, 1.0)) )) * 1.0 + ",
