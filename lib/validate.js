...
var Validate = module.exports = (function(){
    ...
    var USERNAME_ERROR_MSG = "Username must contain at least 1-30 letters, numbers, or underscores."
    // var PASSWORD_ERROR_MSG = "Passphrase must contain at least 8 characters, at least one lower, one uppercase, and one number."
    // var PASSWORD_ERROR_MSG = "Passphrase must contain at least 8 characters, at least one letter and one number."
    var PASSWORD_ERROR_MSG = "Passphrase must contain at least 8 characters"
    ...
    Validate.moveData = function(data){
        try {
    ...
    Validate.mongoID = function(id){
        if (!Validator.isMongoId(id)){
            throw new Error("validate.mongoID")
        }
    }
